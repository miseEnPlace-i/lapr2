...
| Step 7		 |	... instantiating a new adminsitration process	| AdminsitrationProcess	| IE: Owns the data. |
...
| Step 13		 |	... instantiating a new dose information	| DoseInfo	| IE: Owns the data |
