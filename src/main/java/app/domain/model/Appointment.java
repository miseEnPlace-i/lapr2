...
public class Appointment {
   ...
   */
  public Appointment(String snsNumber, Calendar date, String time, VaccinationCenter center,
      VaccineType vacType, boolean sms) {
  ...
  /**
   * Checks if the date of this appointment is in the next hour. TODO: check next slot instead
   */
