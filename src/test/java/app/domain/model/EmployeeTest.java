...
public class EmployeeTest {
  ...
  public void ensureValidEmail() {
    ...
    new Employee("0000000001", "Joana Maria", "Av. da Liberdade", "+351916478865", invalidEmail, "30365258", "Nurse");
  }
  ...
  public void ensureValidPhoneNumberWithValidLength() {
    ...
    new Employee("000000001", "Joana Maria", "Av. da Liberdade", invalidPhoneNumber, "joanamaria@gmail.com", "30365258", "Nurse");
  }
  ...
  public void ensureValidCCNumber() {
    ...
    new Employee("000000001", "Joana Maria", "Av. da Liberdade", "+351916478865", "joanamaria@gmail.com", invalidCCNumber, "Nurse");
  }

  @Test
  public void ensureIsPossibleToCreateEmployee() {
    Employee instance = new Employee("000000001", "Joana Maria", "+351123456789", "email@email.com", "Av. da Liberdade", "12345678", "NURSE");
