...
public class LegacyDataTest {
  ...
  public void setUp() {
    ...
    Employee e2 = new Employee("1", "Name2", "+351916919269", "c@user.com", new Address("street", 1, "1-11", "city"), "15542404", Constants.ROLE_COORDINATOR);
  ...
  public void ensureGettersAreWorkingCorrectly() {
    ...
    assertNotNull(this.ld.getDepartureDate());
