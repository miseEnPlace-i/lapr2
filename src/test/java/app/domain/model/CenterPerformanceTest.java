...
public class CenterPerformanceTest {
  ...
  public void setup() throws ParseException {
    Employee coordinator = new Employee("123456789", "name", "+351212345678",
        "email@email.com", new Address("street", 1, "11-11", "city"),
        "00000000", Constants.ROLE_COORDINATOR);

    center = new HealthCareCenter("name",
        new Address("street", 1, "11-11", "city"), "email@email.com",
        "+351212345678", "+351212345678", "https://ccc.com", new Time("10:00"),
    ...
    SNSUser user = new SNSUser("00000000", "123456789", "name",
        sdfBday.parse("01-02-2022"), Gender.MALE, "+351212345678",
        "email@email.com", new Address("street", 1, "11-11", "city"));

    CenterEventList eventList = this.center.getEvents();
    eventList.save(
        eventList.create(DateUtils.toCalendar(sdf.parse("05-10-2022 10:00")),
            CenterEventType.ARRIVAL, user));
    eventList.save(
        eventList.create(DateUtils.toCalendar(sdf.parse("05-10-2022 10:00")),
            CenterEventType.ARRIVAL, user));
    eventList.save(
    ...
    eventList.save(
        eventList.create(DateUtils.toCalendar(sdf.parse("05-10-2022 10:00")),
            CenterEventType.ARRIVAL, user));
    eventList.save(
        eventList.create(DateUtils.toCalendar(sdf.parse("05-10-2022 10:10")),
            CenterEventType.ARRIVAL, user));
    eventList.save(
        eventList.create(DateUtils.toCalendar(sdf.parse("05-10-2022 10:10")),
            CenterEventType.DEPARTURE, user));
    eventList.save(
        eventList.create(DateUtils.toCalendar(sdf.parse("05-10-2022 10:20")),
            CenterEventType.DEPARTURE, user));
  }
  ...
  public void ensureMaxSumIsCorrect() throws ParseException {
    ...
    CenterPerformance performance = center.getCenterPerformanceForDay(
        DateUtils.toCalendar(sdf.parse("05-10-2022")), 5);
  ...
  public void ensureDifferencesListSizeIsCorrect() throws ParseException {
    SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
    CenterPerformance performance = center.getCenterPerformanceForDay(
        DateUtils.toCalendar(sdf.parse("05-10-2022")), 60);
  ...
  @Test
  public void ensureDifferencesListWithTinyIntervalIsCorrect()
